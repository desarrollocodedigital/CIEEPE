...
<body class="bg-white text-gray-900 antialiased">
    ...
    <main class="pt-32 pb-20">
        <div class="container mx-auto px-4 md:px-8">
            ...
            <!-- Botón Volver -->
            <div class="mb-10">
                <a href="investigadores.php" class="inline-flex items-center text-blue-600 hover:text-blue-800 font-bold transition-colors group">
                    <i data-lucide="arrow-left" class="w-5 h-5 mr-2 group-hover:-translate-x-1 transition-transform"></i> Volver a Investigadores
                </a>
            </div>
                ...
                <div class="md:col-span-4 lg:col-span-3">
                    <div>
                        ...
                        <div class="space-y-6">
                            ...
                            <div class="pt-4">
                                <a href="<?= htmlspecialchars($investigador['cv_url']) ?>" download class="flex items-center justify-between w-full bg-black text-white px-4 py-3 rounded text-sm font-bold hover:bg-gray-800 transition-colors">
