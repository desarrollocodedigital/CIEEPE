    ...
    <header class="bg-white border-b border-slate-200 sticky top-0 z-40">
        <div class="max-w-7xl mx-auto px-4 h-20 flex items-center justify-between">
            ...
            <nav id="navbar" class="flex items-center">
                ...
                <!-- Menú Móvil -->
                <div id="mobile-menu" class="hidden md:hidden bg-white shadow-lg absolute top-full left-0 w-full py-4 px-6 flex flex-col space-y-4 text-gray-800 border-t border-gray-100">
            ...
            <div class="max-w-4xl mx-auto px-4 text-center">
                ...
                <div class="relative max-w-2xl mx-auto">
                    ...
                    <input type="text" id="searchInput"
                        class="w-full bg-slate-50 border border-slate-200 rounded-2xl py-4 pl-12 pr-32 focus:outline-none focus:ring-2 focus:ring-blue-900/20 focus:border-blue-900 transition-all text-slate-800 shadow-sm"
